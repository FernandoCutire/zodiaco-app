   ...
   <html data-dark>
    ...
    <section class="section" data-dark>
        ...
        <div class="formulario" data-dark><br><br>
            ...
            <form method="POST" action="../resultados/resultados_ingles.php"><br>
                ...
                <div class="center">
                    ...
                    <a class="btn-cookie"href="../../../app/Controllers/Cookie/borrarCookie.php">Delete Cookie</a>
                    <a class="btn-cookie" href="../inicio/borrar_contador_ingles.php">Reset Counter</a>
