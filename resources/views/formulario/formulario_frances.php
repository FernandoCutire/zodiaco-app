...
function formulario_frances()
{
    ...
    <html data-dark></html>
    <div class="anuncio">
        <img src="../../imgs/future.png" alt="future" style="width: 150px; height: 150px;">
    ...
    <section class="section" data-dark>
        <div class="formulario" data-dark><br><br>
            ...
            <form method="POST" action="../resultados/resultados_frances.php"><br>
                <label>Nom:  </label>
                ...
                <div class="center">
                    ...
                    <a class="btn-cookie" href="../../../app/Controllers/Cookie/borrarCookie.php">supprimer les cookies</a>
                    <a class="btn-cookie" href="../inicio/borrar_contador_frances.php">réinitialiser le compteur</a>
